...
/**
 * The seam between YourXDemon's UI/service layer and a concrete VM runtime
...
interface VmEngine {
     ...
     */
    fun openHostTransport(): com.opx.yourxdemon.engine.hostbridge.HostTransport? = null
...
/**
 * Engine-agnostic launch parameters. Strict superset of YourXDemonQemu.LaunchConfig
