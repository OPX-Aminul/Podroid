 ...
 */
package com.opx.yourxdemon.ui.screens.x11
...
import com.opx.yourxdemon.x11.ResolutionMode
import com.opx.yourxdemon.x11.ResolutionPreset
import com.opx.yourxdemon.x11.RotationLock
import com.opx.yourxdemon.x11.TouchMode
...
fun X11SettingsSheet(viewModel: X11ViewModel, onDismiss: () -> Unit) {
    ...
    ModalBottomSheet(onDismissRequest = onDismiss) {
        Column(
            ...
            // ── RESOLUTION ────────────────────────────────────────────
            YourXDemonSectionLabel(stringResource(R.string.resolution))
            ...
            // ── ROTATION ──────────────────────────────────────────────
            YourXDemonSectionLabel(stringResource(R.string.rotation))
            ...
            // ── TOUCH ─────────────────────────────────────────────────
            YourXDemonSectionLabel(stringResource(R.string.touch))
            ...
            // ── DISPLAY ───────────────────────────────────────────────
            YourXDemonSectionLabel(stringResource(R.string.display))
...
private fun CustomResolutionFields(
    ...
    Row(
        horizontalArrangement = Arrangement.spacedBy(YourXDemonTokens.Spacing.MD),
        modifier = Modifier.fillMaxWidth(),
    ) {
        OutlinedTextField(
            value = wText,
