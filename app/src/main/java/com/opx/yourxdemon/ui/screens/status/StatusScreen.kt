package com.opx.yourxdemon.ui.screens.status
...
import com.opx.yourxdemon.ui.components.VmLoadGraph
    ...
    Scaffold(
        ...
        AdaptiveContainer(
            ...
            Column(
                ...
                YourXDemonSectionLabel(stringResource(R.string.status_phone_section))
                StatusMetricBar(
                ...
                YourXDemonSectionLabel(stringResource(R.string.status_vm_section))
                YourXDemonListRow(
