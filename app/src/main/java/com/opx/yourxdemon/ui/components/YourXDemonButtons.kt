...
fun YourXDemonPrimaryButton(
    ...
    Button(
        ...
        shape = RoundedCornerShape(YourXDemonTokens.Radius.Button),
...
@Composable
fun YourXDemonDestructiveButton(
    text: String,
    onClick: () -> Unit,
    modifier: Modifier = Modifier,
    icon: ImageVector? = null,
    ...
    OutlinedButton(
        ...
        modifier = modifier.fillMaxWidth().height(44.dp),
        shape = RoundedCornerShape(YourXDemonTokens.Radius.Button),
        border = BorderStroke(1.dp, YourXDemonTokens.Red.copy(alpha = 0.5f)),
        colors = ButtonDefaults.outlinedButtonColors(
            contentColor = YourXDemonTokens.Red,
        ),
    ) {
        if (icon != null) {
            Icon(icon, contentDescription = null, modifier = Modifier.size(18.dp))
