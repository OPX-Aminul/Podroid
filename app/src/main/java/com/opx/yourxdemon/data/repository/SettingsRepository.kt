...
import com.opx.yourxdemon.engine.avf.AvfCpuPolicy
...
class SettingsRepository @Inject constructor(
    ...
    val x11Settings: kotlinx.coroutines.flow.Flow<com.opx.yourxdemon.x11.X11Settings> = context.dataStore.data
        .catch { e -> if (e is IOException) emit(androidx.datastore.preferences.core.emptyPreferences()) else throw e }
        .map { p ->
        com.opx.yourxdemon.x11.X11Settings(
            resolutionMode = runCatching { com.opx.yourxdemon.x11.ResolutionMode.valueOf(p[KEY_X11_RES_MODE] ?: "MATCH") }.getOrDefault(com.opx.yourxdemon.x11.ResolutionMode.MATCH),
            preset = runCatching { com.opx.yourxdemon.x11.ResolutionPreset.valueOf(p[KEY_X11_RES_PRESET] ?: "R1080P") }.getOrDefault(com.opx.yourxdemon.x11.ResolutionPreset.R1080P),
            customW = p[KEY_X11_CUSTOM_W] ?: 1280,
            customH = p[KEY_X11_CUSTOM_H] ?: 720,
            touchMode = runCatching { com.opx.yourxdemon.x11.TouchMode.valueOf(p[KEY_X11_TOUCH_MODE] ?: "DIRECT") }.getOrDefault(com.opx.yourxdemon.x11.TouchMode.DIRECT),
            ...
            rotationLock = runCatching { com.opx.yourxdemon.x11.RotationLock.valueOf(p[KEY_X11_ROTATION] ?: "AUTO") }.getOrDefault(com.opx.yourxdemon.x11.RotationLock.AUTO),
    ...
    // Snapshots used by non-Compose call sites (YourXDemonService, exporters).
