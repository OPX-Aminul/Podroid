...
import com.opx.yourxdemon.service.VmControlReceiver
import com.opx.yourxdemon.ui.navigation.NavGraphViewModel
import com.opx.yourxdemon.ui.navigation.YourXDemonNavGraph
import com.opx.yourxdemon.ui.theme.YourXDemonTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val headlessVm: com.opx.yourxdemon.ui.HeadlessViewModel = hiltViewModel()
            ...
            YourXDemonTheme(darkTheme = darkTheme, dynamicColor = dynamicColor) {
                Surface(
                    modifier = Modifier.fillMaxSize(),
                    color = MaterialTheme.colorScheme.background,
                ) {
                    androidx.compose.foundation.layout.Box(Modifier.fillMaxSize()) {
                        YourXDemonNavGraph(windowSizeClass = windowSizeClass)
                        if (headlessActive) {
                            com.opx.yourxdemon.ui.components.HeadlessOverlay(onExit = { headlessVm.disable() })
                        }
                    }
                }
            }
